    ...
    func testProgressFeedUsesQueryAndDecodesPage() async throws {
        ProgressURLProtocol.handler = { request in
            ...
            return try Self.response(
                for: request,
                json: #"{"posts":[{"id":"p1","project": {"id": "project-hiboss", "slug": "hiboss", "display_name": "hiboss"},"agent_id":"ak1","agent_name":"cli","body":"Hi","media":[],"tags":[],"created_at":"2026-08-14T08:00:00Z"}],"next_cursor":null}"#
            )
        }
    ...
    func testProgressFeedDecodesMediaVariantsAndCompositeCursor() async throws {
        ProgressURLProtocol.handler = { request in
            try Self.response(
                ...
                json: #"""
                {"posts":[
                    {"id":"none","project": {"id": "project-p", "slug": "p", "display_name": "p"},"agent_id":"a","agent_name":"cli","body":"none","created_at":"2026-08-14T08:00:00Z"},
                    {"id":"image","project": {"id": "project-p", "slug": "p", "display_name": "p"},"agent_id":"a","agent_name":"cli","body":"image","media":[{"url":"https://h/i.png","kind":"image","content_type":"image/png","size":3,"width":12,"height":8}],"tags":[],"created_at":"2026-08-14T07:00:00Z"},
                    {"id":"video","project": {"id": "project-p", "slug": "p", "display_name": "p"},"agent_id":"a","agent_name":"cli","body":"video","media":[{"url":"https://h/v.mp4","kind":"video","content_type":"video/mp4","size":4,"duration_ms":3200,"poster_url":"https://h/p.jpg"}],"created_at":"2026-08-14T06:00:00Z"},
                    {"id":"missing-dimensions","project": {"id": "project-p", "slug": "p", "display_name": "p"},"agent_id":"a","agent_name":"cli","body":"missing","media":[{"url":"https://h/m.png","kind":"image","content_type":"image/png","size":5}],"created_at":"2026-08-14T05:00:00Z"}
