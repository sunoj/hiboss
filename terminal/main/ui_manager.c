...
// Chinese font (generated by lv_font_conv from Noto Sans SC)
...
static void create_messages_screen(const hiboss_message_t *msgs, int count)
{
    ...
    lv_obj_set_style_text_font(lbl_body, &font_cn_16, 0);
    ...
    // Quick react buttons (moved up for circular screen — edges are clipped)
    ...
    for (int i = 0; i < 3; i++) {
        ...
        lv_obj_align(btn, LV_ALIGN_BOTTOM_MID, (i - 1) * 80, -70);
