...
final class ProgressFeedDecodingTests: XCTestCase {
    func testDecodesPostWithNoMedia() throws {
        ...
        {
          "id": "p1",
          "project": "hiboss", "project_ref": {"id": "project-hiboss", "slug": "hiboss", "display_name": "hiboss"},
          "agent_id": "ak1",
    ...
    func testDecodesUnregisteredTeam() throws {
        ...
        {
          "id": "p7",
          "project": "payments", "project_ref": {"id": "project-payments", "slug": "payments", "display_name": "payments"},
          "agent_id": "ak2",
