...
const SCHEMA_STATEMENTS = [
  "CREATE TABLE IF NOT EXISTS api_keys (id TEXT PRIMARY KEY DEFAULT (lower(hex(randomblob(16)))), name TEXT NOT NULL, key_hash TEXT NOT NULL UNIQUE, callback_url TEXT, created_at TEXT NOT NULL DEFAULT (datetime('now')), last_used_at TEXT)",
