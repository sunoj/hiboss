...
import { bossClientsRouter } from './boss-clients';
...
app.use(
  ...
  cors({
    ...
    allowHeaders: ['Authorization', 'Content-Type', 'Idempotency-Key', 'X-Panel-Connection-Ticket'],
...
app.route('/api/boss/agents', bossAgentKeysRouter);
